...
#owner = LINETCR.LINE() #Akun Utama
#owner.login(token="token")
#owner.loginResult()
    
vipro = LINETCR.LINE()
vipro.login(token="Es9xrRlatgcF6MbGLfn4.InGa75TRayFTfuuFrPeJ1a.V9j7F8pjaaeRMdvD24yVzusX9Nc2GjntzVEB4VbhsMg=")
vipro.loginResult()

ki = LINETCR.LINE()
ki.login(token="EsvJk2lK7TzmnIHyJMK3.GLoAPUWtFWBdZrXMVnjSiW.PNMSCNV+bVz/9r+99qOC6LjUXXQ0quOkP7H8j6MvUkI=")
ki.loginResult()

ki2= VIPRO.LINE()
ki2.login(token="EsdEkucoJGWTqYu8y6pb.JmKQqtjNPq+gtvhYJBOJIW.9/blF3GBxb3l8Fn9aTWiYI8FnIdAeUBYjkQzCOFvVYk=")
ki2.loginResult()

ki3 = VIPRO.LINE()
ki3.login(token="EsjITdmS1Q23KEMVFbH9.KbMq4fWrhftskN0ZQrMcwq.5NEtAEP3osFGF6vB5FsrnMENBJw+bxiVowW+50LtzSc=")
ki3.loginResult()
...
creator=["u88d800ef9b6b0187ed15451f469123d4"]
admsa=["u88d800ef9b6b0187ed15451f469123d4"]
...
#=====================================================================================   
              ...
              if msg.from_ in creator + admin:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'u88d800ef9b6b0187ed15451f469123d4'}
                vipro.sendText(msg.to,"❂•••••••••✧••••••••••❂")
                vipro.sendMessage(msg)
